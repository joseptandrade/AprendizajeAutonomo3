...
###Iniciamos nuestro bucle comparando la variable numero si es menor o igual
###Si se cumple ingresamos al bucle
while numero <= i:
    ###A la variable numero la vamos ingrementando en uno para luego realizar la comparacion al inicio del blucle
    numero += 1
    ###Pedimos a los jugadores ingresar la opcion que van a elegir 
    ...
    ###Iniciamos las condicionales para cada opcion de ingreso, al cumplirse se imprime mensaje con el numero del jugador que gane 
    ##Comparamos los posibles ingresos para la opcion 1 que es Piedra
    if j1 == 1 and j2 == 2:
            ...
            g1 +=1
    ##Comparamos los posibles ingresos para la opcion 2 que es Papel
    elif j1 == 2 and j2 == 1:
            ...
            g2 +=1
    ##Comparamos los posibles ingresos para la opcion 3 que es Tijeras
    elif j1 == 3 and j2 == 1:
        ...
        g1 +=1
    ###Comparamos los posibles ingresos para la opcion 4 que es Spock
    elif j1 == 4 and j2 == 1:
        ...
        g2 +=1
    ###Comparamos l0s posibles ingresos para la opcion 5 que es lagarto
    elif j1 == 5 and j2 == 1:
        ...
        ###En caso de no cumplise las condiciones se imprime lo siguiente
        print("Jugadores quedaron empate")
### Comparamos si el contador g1 es mayo que g2 si se cumple la condicion se imprime lo siguiente
if g1 > g2:
     print("Jugador 1 has ganado", g1 ,"veces la partida")
     print("Eres el ganador de la partida, el juego a terminado gracias")
### Comparamos si el contador g2 es mayo que g1 si se cumple la condicion se imprime lo siguiente
elif g2 > g1:
